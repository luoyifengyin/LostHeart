...
public class Advertisement : MonoBehaviour
{
    ...
    void Start()
    {
        //asd.text = Application.streamingAssetsPath;
        //Debug.Log(Application.streamingAssetsPath);
        System.Drawing.Image image = System.Drawing.Image.FromFile("c:/Users/timg.gif");//Application.streamingAssetsPath + "/timg.gif");
    ...
    void Update()
    {
        ...
        {
            SkipScene.adTime += Time.deltaTime;
            int index = (int)(SkipScene.adTime * fps) % tex2DList.Count;
            if (Im != null)
            {
