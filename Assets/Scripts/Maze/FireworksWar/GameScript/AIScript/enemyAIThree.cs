...
public class enemyAIThree : MonoBehaviour
{
    ...
    void OnCollisionStay(Collision other)
    {
        ...
        if (other.collider.tag == "PlayerFireworks")
        {
            ...
            {
                uii.killInformation(PlayerPrefs.GetString("PlayerName"), "可回收垃圾");
            }
        ...
        if (other.collider.tag == "AIFireworks1")
        {
            ...
            uii.killInformation("有害垃圾", "可回收垃圾");
            Destroy(this.gameObject);
        }
        ...
        if (other.collider.tag == "AIFireworks")
        {
            ...
            uii.killInformation("垃圾分类", "可回收垃圾");
            Destroy(this.gameObject);
