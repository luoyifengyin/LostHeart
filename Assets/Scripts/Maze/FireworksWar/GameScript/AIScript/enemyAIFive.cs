...
public class enemyAIFive : MonoBehaviour
{
    ...
    void OnCollisionStay(Collision other)
    {
        ...
        if (other.collider.tag == "PlayerFireworks")
        {
            ...
            {
                uii.killInformation(PlayerPrefs.GetString("PlayerName"), "干垃圾");
            }
