...
namespace MyGameApplication {
    ...
    public static class SerializedPropertyExtensions {
        ...
        public static void AddToObjectArray<T>(this SerializedProperty arrayProperty, T elementToAdd, int index = -1)
            where T : Object {
            ...
            // Add a null array element at the index of the array then populate it with the object parameter.
        ...
        public static int RemoveFromObjectArray<T>(this SerializedProperty arrayProperty, T elementToRemove)
            where T : Object {
